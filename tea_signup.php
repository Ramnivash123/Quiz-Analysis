...
include 'db.php'; // Ensure this initializes a PDO connection in $conn
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        $stmt = $conn->prepare("INSERT INTO tea_signup (na, em, pass) VALUES (:name, :email, :password)");
...
<body class="bg-green-50 flex justify-center items-center min-h-screen">
    <div class="bg-white rounded-lg shadow-lg p-8 w-full max-w-md">
        <h2 class="text-3xl font-bold text-green-800 text-center mb-6">Teacher Sign Up</h2>
